...
import visapIcon from '@icons/icon-visa.png'
import masterCardpIcon from '@icons/icon-mastercard.png'
import privatIcon from '@icons/icon-privat-credit.png'
import muttevaIcon from '@icons/logo-mutteva.png'
import privatbankIcon from '@icons/logo-privatbank-short.png'
import sensIcon from '@icons/logo-sens.png'
...
export const Footer = () => {
    ...
    return <footer className="footer">
        <div className="footer__header">
            <div className="main__container footer__header-container">
        ...
        <div className="footer__down">
            <div className="main__container footer__down-container">
                <div className="payment__info">
                    <span>Ми приймаємо:</span>
                    <div className="payment__info-icons">
                        <img src={visapIcon} alt="" />
                        <img src={masterCardpIcon} alt="" />
                        <img src={privatIcon} alt="" />
                        <img src={muttevaIcon} alt="" />
                        <img src={privatbankIcon} alt="" />
                        <img src={sensIcon} alt="" />
                    </div>
                </div>
                <p>example.ua, 2014-2021 ©</p>
            </div>
        </div>
</footer>
}